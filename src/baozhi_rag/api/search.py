...
from baozhi_rag.api.dependencies import get_chunk_search_service, get_current_user
...
def search_chunks(
    ...
    hits = service.search(q, size or default_size, viewer_user_id=current_user.id)
